...
public class WhatsappSender {
  ...
  private static final String INSTANCE_ID = "FREE_TRIAL_ACCOUNT";
  ...
  public static void main(String[] args) throws Exception {
    String number = "5511969811431";  //  TODO: Specify the recipient's number here. NOT the gateway number
    String message = "Eita porra, funcionou!!!";
