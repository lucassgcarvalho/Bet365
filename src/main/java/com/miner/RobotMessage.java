...
public class RobotMessage extends TelegramLongPollingBot {
	...
	private static final String USER_NAME_ROBOT_BET_GROUP = "robotBetHomolog";
	private static final String TOKEN_ROBOT_BET_GROUP = "385100995:AAEB7lY9xy6VUxxY9u9Qic4S2r1-tk82sO4";
	private static final String CHAT_ID_ROBOT_BET_GROUP = "-282205695";
	
	 /*"chat":{  
        "id":-282205695,
        "title":"Bet365Automation",
        "type":"group",
