...
public class CopyOfBot_10_01 {
	 ...
	 * Pega na posi��o 1
	 */
	public static final String XPATH_LIST_PLAYER_NAME = ".//div[contains(@class,'ipn-FixtureButton')]/div[contains(@class,'ipn-TeamStack')]/div[@class='ipn-TeamStack_Team'][1]";
	...
	public void fecharAba(String aba, Locomotive loco) {
		// Fecha Aba Futebol
		List<WebElement> temasJogos = loco.getWebElements(By.xpath(CopyOfBot_10_01.XPATH_MENUS_JOGOS));
...
//	}
	...
	public void clickAbaDeuce(WebElement deuce) {
		...
		try {
			classAbaDeuce = deuce.findElement(By.xpath(CopyOfBot_10_01.XPATH_PARENT)).getAttribute("class");
		} catch (Exception e) {
			//System.out.println("Falha ao obter parent class da aba Deuce. "+ Bot.XPATH_PARENT+ "\n"+ e.getMessage());
		}
		if (!classAbaDeuce.contains(CopyOfBot_10_01.STRING_OPEN)) {
			deuce.click();
		}
	}
	...
	public void clickOdds(WebElement deuce, Locomotive loco)throws Exception {
		loco.waitForCondition(ExpectedConditions.visibilityOfElementLocated(By.xpath(CopyOfBot_10_01.XPATH_SPAN_ODDS)));
		WebElement webElementValorOdds = deuce.findElements(By.xpath("../.."+ CopyOfBot_10_01.XPATH_SPAN_ODDS)).get(1);
		...
		try {
			try {
				while (!apostaEfetuada) {
					try {
						//double Check
						if(!loco.isPresent(By.xpath(CopyOfBot_10_01.XPATH_LI_TODAS_APOSTAS))){
							throw new Exception();
						}else if (loco.driver.findElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)).isDisplayed()) {
							loco.driver.findElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)).click();
						}
						...
						if (loco.isPresent(By.xpath("//div[@class='bs-Btn bs-BtnHover']"))) {
							...
							loco.waitForElement(By.xpath("//span[@class='br-Header_Done']"), CopyOfBot_10_01.DOIS_SEGUNDO_MILLI);
							if (loco.isPresent(By.xpath("//span[@class='br-Header_Done']"))) {
								apostaEfetuada = true;
							}
						}
						if (loco.isPresent(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO))) {
							loco.driver.findElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)).click();
						...
						loco.waitForElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO));
						if (loco.isPresent(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)) && loco.driver.findElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)).isDisplayed()) {
							loco.driver.findElement(By.xpath(CopyOfBot_10_01.BTN_ACEITAR_ALTERACOES_POR_DESCRICAO)).click();
	...
	public boolean executarAposta(Map<String, Partida> mapGames, Locomotive loco, String keyEntrySet, boolean tipoAposta, WebElement apostaSelecionada) throws ParseException {
		if (CopyOfBot_10_01.PRODUCAO == tipoAposta) {
			return realizarAposta(mapGames, loco, keyEntrySet, apostaSelecionada);
		} else {
			
			inserirValorAposta(loco, apostaSelecionada, mapGames.get(keyEntrySet));
			
			loco.waitForCondition(ExpectedConditions.visibilityOfElementLocated(By.xpath(CopyOfBot_10_01.XPATH_REMOVER_TODAS_APOSTAS)));
			WebElement btnRemoverApostas = loco.getWebElement(By.xpath(CopyOfBot_10_01.XPATH_REMOVER_TODAS_APOSTAS));
	...
	public BigDecimal inserirValorAposta(Locomotive loco, WebElement apostaSelecionada, Partida partidaAtual) throws ParseException{
		loco.waitForCondition(ExpectedConditions.visibilityOfElementLocated(By.xpath(CopyOfBot_10_01.XPATH_INPUT)));
		...
		apostaSelecionada.findElement(By.xpath(CopyOfBot_10_01.XPATH_INPUT)).sendKeys(getValorApostaCalculado(partidaAtual).toString());
		
		WebElement webElementRetorno = apostaSelecionada.findElement(By.xpath("//div[@class='bs-StakeToReturn']"));
		String valor = webElementRetorno.getText().substring(CopyOfBot_10_01.STRING_RETORNOS.length());
	...
	public BigDecimal getValorApostaCalculado(Partida partidaAtual) throws ParseException{
		...
		if (partidaAtual.getPartidaAnterior() != null
				...
				&& partidaAtual.getPartidaAnterior().getQuantidadeEmpates() <= CopyOfBot_10_01.MAXIMO_EMPATES) {
			valorAposta = calcularValorAposta(partidaAtual.getPartidaAnterior().getValorAposta(), true, partidaAtual);
		} else
			valorAposta = calcularValorAposta(CopyOfBot_10_01.VALOR_PADRAO_APOSTA, false, partidaAtual);
	...
	public BigDecimal processarApostaGanha(RobotMessage robotMessage, Map<String, Partida> mapGames, 
		...
		WebElement horarioAposta = loco.getWebElement(By.xpath(CopyOfBot_10_01.XPATH_TIME_SERVER));
...
//		/partidaAtual.setPartidaAnterior(null);
	...
	public WebElement getAbaDeuce(Locomotive loco, String nomeJogador, String nomeJogadorAdversario, Integer numeroApostaAtual) {
		try {
			...
			if (!loco.isPresent(By.xpath(CopyOfBot_10_01.XPATH_LINK_ABA_DEUCE))) {
				return null;
			...
			List<WebElement> abaDeuce = loco.getWebElements(By.xpath(CopyOfBot_10_01.XPATH_LINK_ABA_DEUCE));
